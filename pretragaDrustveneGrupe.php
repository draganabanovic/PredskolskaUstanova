...
<body class="sub_page">
  ...
  <section class="contact_section min-visina ">
    <div class="container">
        ...
        <div class="col-md-6">
          ...
          <form role="form" method='POST' action="">
            <div class="contact_form-container">
              ...
              <!--na svaki unos novog karaktera odnosno promenu u inputu pozivace se javascript-->
      ...
      <button  id="dugmeZaTeblu" class="btn mt-2 text-white" style="background-color: #6bd1bd;">Prikaz svih društvenih grupa <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
  ...
  <table id="tabela" class="table text-center mt-5" style="display:none">
      ...
      <?php
        ...
        //prikaz svih
        $rezultat = $drustvenaGrupa->preuzmiDrustveneGrupe();
        ...
        if ($brredova>0)
            {
              ...
              {
                $i++;
                $id=$red['ID_DRUSTVENE_GRUPE'];
                $naziv=$red['NAZIV_DRUSTVENO_OSETLJIVE_GRUPE'];
                ?>
                    <tr>
                        <td class="align-middle"><?php echo $i ?></td> 
                        <td  class="align-middle"><?php echo $naziv ?></td>                    
                        <td class="align-middle pl-3">
                        <a href="unosDrustveneGrupe.php?id=<?php echo $id;?>">
                        ...
                        <a onclick="return confirm('Da li želite da obrišete?');" href="admin/obrisiDrustvenuGrupu.php?id=<?php echo $id;?>" class="align-middle text-danger" title="Delete" data-toggle="tooltip">

...
<body class="sub_page">
  ...
  <section class="contact_section min-visina">
    <div class="container">
      ...
      <button  id="dugmeZaTeblu" class="btn mt-2 text-white" style="background-color: #6bd1bd;">Prikaz svih mesta <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
        ...
        if ($brredova>0)
            {
              ...
              {
                $i++;
                $mesto=$red['NAZIV_MESTA'];
                $opstina=$red['NAZIV_OPSTINE'];
                $drzava=$red['DRZAVA'];
                $id=$red['ID_MESTA'];
                ?>
                    <tr>
                        <td class="align-middle"><?php echo $i ?></td> 
                        <td  class="align-middle"><?php echo $mesto ?></td>                    
                        <td class="align-middle"><?php echo $opstina ?></td>
                        <td class="align-middle"><?php echo $drzava ?></td>
                        <td class="align-middle pl-3">
                        <a href="unosMesta.php?id=<?php echo $id;?>">
                        ...
                        <a onclick="return confirm('Da li želite da obrišete?');" href="admin/obrisiMesto.php?id=<?php echo $id;?>" class="align-middle text-danger" title="Delete" data-toggle="tooltip">

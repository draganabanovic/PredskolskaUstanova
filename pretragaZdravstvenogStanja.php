...
<body class="sub_page">
  ...
  <section class="contact_section min-visina">
    <div class="container">
      ...
      <button  id="dugmeZaTeblu" class="btn mt-2 text-white" style="background-color: #6bd1bd;">Prikaz svih zdravstvenih stanja <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
  ...
  <table id="tabela" class="table text-center mt-5" style="display:none">
      ...
      <?php
        ...
        $rezultat = $zdravstvenoStanje->preuzmiZdravstvenaStanja();
        ...
        if ($brredova>0)
            {
              ...
              {
                $i++;
                $id=$red['ID_ZDRAVSTVENOG_STANJA'];
                $naziv=$red['NAZIV_STANJA'];
                ?>
                    <tr>
                        <td class="align-middle"><?php echo $i ?></td> 
                        <td  class="align-middle"><?php echo $naziv ?></td>                    
                        <td class="align-middle pl-3">
                        <a href="unosZdravstvenogStanja.php?id=<?php echo $id;?>">
                        ...
                        <a onclick="return confirm('Da li želite da obrišete?');" 
                        href="admin/obrisiZdravstvenoStanje.php?id=<?php echo $id;?>" 
